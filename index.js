...
function createSymbol() {
  const symbol = Symbol();
  return symbol;
  // Створюємо символ symbol без опису
...
// Функція getSymbolKey приймає символ як аргумент та повертає ключ, який був використаний для 
//його створення
...
function useSymbolDescription() {
  ...
  let symbolDescriprion = mySymbol.description;
  return symbolDescriprion;
